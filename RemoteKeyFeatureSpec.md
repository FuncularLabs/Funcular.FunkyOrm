> ⚠️ **DEPRECATED LOCATION** — This file has moved to `docs/plans/_completed/RemoteKeyFeatureSpec.md`.
> This copy is retained for backward compatibility. All edits should go to the new location.
