...
{
    /// <summary>
    /// Visits LINQ expressions to generate SQL WHERE clauses with parameterized MySQL queries.
    /// </summary>
    /// <typeparam name="T">The type of entity being queried.</typeparam>
    public class MySqlWhereClauseVisitor<T> : BaseExpressionVisitor<T> where T : class, new()
    {
