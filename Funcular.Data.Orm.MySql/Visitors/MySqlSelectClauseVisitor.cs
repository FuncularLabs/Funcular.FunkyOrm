...
{
    /// <summary>
    /// Visits LINQ expressions to generate SQL SELECT clauses with projections for MySQL.
    /// </summary>
    public class MySqlSelectClauseVisitor<T> : BaseExpressionVisitor<T> where T : class, new()
    {
